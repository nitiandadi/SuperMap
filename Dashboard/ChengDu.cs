...
namespace Dashboard
{
    ...
    {
        public ChengDu(MapControl mapControl,ComboBox comboBox,DataGridView dataGridView,TrackBar trackBar)
        {
            this.name = "成都";
            this.Center = new Point2D(104.06, 30.67);
        ...
        {
            //this.datasource = new Datasource(EngineType.UDBX);
            //string path = @"D:\Documents\桌面\1\gis软件开发作业\1.udbx";
            //var connectionInfo = new DatasourceConnectionInfo(path, "ChengDu", "");
            //connectionInfo.EngineType = EngineType.UDBX;
            ////this.datasource.Open(connectionInfo);
            //mapControl.Map.Workspace.Datasources[2].Open(connectionInfo);
            this.datasource = mapControl.Map.Workspace.Datasources[3];
        }
